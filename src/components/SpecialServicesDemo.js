...
function SpecialServicesDemo() {
  ...
  const [scroller1, setScroller1] = useState("scroll")
  const [scroller2, setScroller2] = useState("scroll1")
  const [scroller3, setScroller3] = useState("scroll2")
  ...
  function distributionf() {
    ...
    setPageData('06')
    setScroller2("scro6l1")
    setScroller3("scro6l2")
  ...
  function airfreightf() {
    ...
    setPageData('04')
    setScroller2("scro4l1")
    setScroller3("scro4l2")
  ...
  function oceanfreightf() {
    ...
    setPageData('05')
    setScroller2("scro5l1")
    setScroller3("scro5l2")
  ...
  function importexpressf() {
    ...
    setPageData('02')
    setScroller1("scro2l")
    setScroller2("scro2l1")
    setScroller3("scro2l2")
  ...
  function domesticexpressf() {
    ...
    setPageData('01')
    setScroller1("scroll")
    setScroller2("scroll1")
    setScroller3("scroll2")
  ...
  function roadexpressf() {
    ...
    setPageData('03')
    setScroller1("scro3l")
    setScroller2("scro3l1")
    setScroller3("scro3l2")

  }

  function both(list) {

    if (list.id === 1) { domesticexpressf() }
    else if (list.id === 2) {
      importexpressf()
    } else if (list.id === 3) {
      roadexpressf()
  ...
  return (
    ...
    <div className={scroller1}></div>
      <div className={scroller2}></div>
      <div className={scroller3}></div>
