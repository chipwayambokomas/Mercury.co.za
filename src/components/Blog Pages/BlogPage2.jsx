...
import timeline2 from "C:/Users/Sabo/OneDrive/Pictures/Documents/Tigmoo/mercuryv3/src/assests/timeline2.png"
...
const BlogPage1 = () => {
    ...
    const chips = [
        'Road Freight', 'Road Travel', 'Import Tax'
      ]
    ...
    return (
        <>
            ...
            <div className='TheFinalFrontier'>
                <header>
                    <h1 className='BlogTitle-A'>New energy source makes logistics operations cheaper!</h1>
